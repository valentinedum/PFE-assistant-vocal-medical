...
class SlotsInfo(BaseModel):
    date: Optional[str] = Field(None, description="Date du RDV (ex: 'lundi', '5 mars', 'demain')")
...
class ClinicInfoType(BaseModel):
    requested_info: str = Field(..., description="Type: address, hours, phone, specialists, price, parking")
